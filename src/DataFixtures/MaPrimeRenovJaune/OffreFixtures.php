...
class OffreFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    const OFFRES = [
        [
            ...
            'NOM' => 'Chaudières à gaz très haute performance',
            'OUVRAGES' => [ 'TH_02' ],
            'CONDITIONS' => [],
            'VALEURS' => [
                [
            ...
            'VALEURS' => [
                [
                    ...
                    'DESCRIPTION' => 'Prime forfaitaire',
                    'CONDITIONS' => [],
                    'EXPRESSION' => '$NOMBRE_EQUIPEMENTS * 80'
                ]
            ],
            ...
            'VALEURS' => [
                [
                    ...
                    'DESCRIPTION' => 'Prime forfaitaire',
                    'CONDITIONS' => [],
                    'EXPRESSION' => '$SURFACE_ISOLANT * 100'
                ]
            ],
            'VARIABLES' => [ 'SURFACE_ISOLANT' ]
        ], [
            ...
            'VALEURS' => [
                [
                    ...
                    'EXPRESSION' => '$SURFACE_PROTEGEE * 20'
                ]
            ],
